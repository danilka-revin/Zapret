...
```bash
python3 -m pytest tests -q                    # 55 модульных тестов ядра, темы, пресетов и подбора
python3 tools/smoke_test.py                   # 64 проверки: клики по всем кнопкам
