...
6. **Приложение установилось через `sudo`, окна нет и на столе пусто.** Всё
   ...
   ```
7. **Ярлык есть в меню, но нет значка на рабочем столе.** Кнопка
...
8. **Всё равно не ясно.** Откройте «Диагностику» (видно состояние nfqws, правил,
