...
python3 tools/smoke_test.py                   # 37 проверок: клики по всем кнопкам
...
автопилот, все панели, кастомизация, горячие клавиши. Именно такой тест ловит
ситуацию «кнопка не работает».
